...
*/
createMenuItem("fries",5,"lunch");
createMenuItem("salsa",15,"apetizer");
createMenuItem("burger",10,"dinner");
  ...
  category: "Lunch",
    discount: function(str) {
      if (str === "teacher" || str === "student") {
        discPrice = burger.price - (burger.price * 0.25);
      } else {
        discPrice = burger.price - (burger.price * 0.10);
      }
      return discPrice;
    }
}
...
function addReview(array, name, rating, feedback){
  const newObject = {name: name, rating: rating, feedback:  feedback}
...
Use the getLongReviews function below to do the following:
  ...
  [
    {name: "Wen", rating: 4.5,sfeedback:"I don't leave my house often, but when I do, it's for this place. Highly reccomend."},
    {name: "Brett", rating: 3, feedback: "great selection of snacks and a nice cafe area to get work done during the day."},
    {name: "Julius", rating: 2, feedback: "I was largely unimpressed by this venue. Nothing special on the menu and too expensive. The atmosphere is polarizing, and not for me, but I think some would like it." }
  ]
*/
